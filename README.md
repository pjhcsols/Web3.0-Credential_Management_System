...
|Team Leader[BACKEND] <br> Infra Cloud Engineer <br> DevOps<br>BlockChain 및 인증서 데이터, PDF 관리<br>인증서 암호화/복호화 관리<br>외부 API 인증 서비스 구축<br> | 외부API 테스트 | iOS 개발 | 인증서 PDF 관리 |
<br>
<br>
<br>
<br>
